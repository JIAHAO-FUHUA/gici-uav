...
protected:
  ...
  // Add Odom measurements and state --sbs
  bool addOdomMeasurementAndState();


  // Marginalization
  bool marginalization(const IdType& type);
  bool gnssMarginalization();
  bool odomMarginalization();
...
protected:
  ...
  int odometer_flag = 0; // tmp var for odometer -sbs
