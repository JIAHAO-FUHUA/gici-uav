...
// Get is_post_process_ and use_precise_product_ --sbs  
// static bool getIsPostProcess() { return is_post_process_; }
// static bool getUsePreciseProduct() { return use_precise_product_; }
