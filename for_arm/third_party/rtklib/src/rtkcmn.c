...
extern int doy2time(const int year, const int doy, const double sod, gtime_t *t)
{
    int month = 0;
    int day = 0;
...
* return : gtime_t struct
*-----------------------------------------------------------------------------*/
extern void yeardoy2monthday(int iyear, int idoy, int *pmonth, int *pday) {
    ...
    for (*pmonth = 1; *pmonth <= 12; (*pmonth)++) {
      id = id - days_in_month[(*pmonth) - 1];
      if (id > 0) continue;
      *pday = id + days_in_month[(*pmonth) - 1];
      break;
    }
}


// otime& otime::setdoy(int year, int doy, double secondofday) {
//   _year=year;
//   otime::yeardoy2monthday(year, doy,_month,_day);
//   _hour=(int)floor(secondofday/3600);
//   _minute=(int)floor((secondofday-_hour*3600)/60);
//   _second=secondofday-_hour*3600-_minute*60;
//   _mjd = otime::modified_julday(_day, _month, _year);
//   _sod = secondofday;
//   return *this;
// }
